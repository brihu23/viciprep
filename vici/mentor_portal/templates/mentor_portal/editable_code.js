$(document).ready(function() {
            ...
            var base = new Airtable({apiKey: dogpark + catpark + hugo + piper + mango + icecream}).base('appeukvokZltY5cuI');   
            var base1 = new Airtable({apiKey: dogpark + catpark + hugo + piper + mango + icecream}).base('appaaHT8iiSvw77Jt');
